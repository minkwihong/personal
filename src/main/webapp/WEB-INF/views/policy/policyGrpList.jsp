		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">PolicyGrpList</li>
				</ol>
			</section>
	...
	<script>
		...
		function initSucess(result) {
			...
			for (var i = 0; i < objList.length; i++) {
				...
				var a_link = "policyGrpModifyView.do?x="
						+ encodeURI(encodeURIComponent(objList[i].name));

				var t_row = "<tr>\n" + "  <td>" + (idx_b--) + "</td>\n" +

				"  <td><a href='" + a_link + "'>" + objList[i].name	+ "</a></td>\n" +
				"  <td>" + isNull(objList[i].grpDesc) + "</td>\n" +
		...
		function registView() {
			var a_link = "policyGrpRegistView.do";
